...
```{r}
getwd()
survdata <- read_csv("C:\\Users\\hp\\Desktop\\MDS work\\Capstone\\Bottlenecks_MDS_Capstone\\survival_analysis\\preprocessed_data\\survival_analysis_small.csv")
...
hatchsimple <- hatchtotal[c(1, 42, 37:41)]
head(hatchsimple)
head(hatchtotal)
